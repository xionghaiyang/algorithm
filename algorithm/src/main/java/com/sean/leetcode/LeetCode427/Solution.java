package com.sean.leetcode.LeetCode427;

/**
 * @Author xionghaiyang
 * @Date 2025-07-28 09:34
...
public class Solution {
    ...
    private Node process(int[][] grid, int r0, int c0, int r1, int c1) {
        ...
        return new Node(true,
                false,
                process(grid, r0, c0, (r0 + r1) >> 1, (c0 + c1) >> 1),
                process(grid, r0, (c0 + c1) >> 1, (r0 + r1) >> 1, c1),
                process(grid, (r0 + r1) >> 1, c0, r1, (c0 + c1) >> 1),
                process(grid, (r0 + r1) >> 1, (c0 + c1) >> 1, r1, c1));
    }
