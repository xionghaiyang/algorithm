package com.sean.leetcode.LeetCode514;
...
/**
 * @Auther: xionghaiyang
 * @Date: 2024-01-29 13:11
 * @Description: https://leetcode.cn/problems/freedom-trail/
 * 514. 自由之路
...
public class Solution {
    ...
    public int findRotateSteps(String ring, String key) {
        ...
        //dp[i][j]表示从前往后写出key的前i个字符，ring的第j个字符与12:00方向对齐的最少步数
        int[][] dp = new int[m][n];
        for (int i = 0; i < m; i++) {
