...
public class Code02_NumberOfIslands {
    ...
    public char[][] generateRandomMatrix(int row, int col) {
    ...
    public static void main(String[] args) {
        ...
        row = 1000;
        col = 1000;
        Code02_NumberOfIslands solution = new Code02_NumberOfIslands();
        board1 = solution.generateRandomMatrix(row, col);
        board2 = solution.copy(board1);
        board3 = solution.copy(board1);

        System.out.println("感染方法、并查集(map实现)、并查集（数组实现）的运行结果和运行时间");
        System.out.println("随机生成的二维矩阵规模:" + row + " * " + col);

        start = System.currentTimeMillis();
        System.out.println("感染方法的运行结果: " + solution.numIslands3(board1));
        end = System.currentTimeMillis();
        System.out.println("感染方法的运行时间: " + (end - start) + " ms");

        start = System.currentTimeMillis();
        System.out.println("并查集（map实现）的运行结果: " + solution.numIslands1(board2));
        end = System.currentTimeMillis();
        System.out.println("并查集（map实现）的运行时间: " + (end - start) + " ms");

        start = System.currentTimeMillis();
        System.out.println("并查集（数组实现）的运行结果: " + solution.numIslands2(board3));
        end = System.currentTimeMillis();
