...
public class Code02_EveryStepShowBoss {
    ...
    public List<List<Integer>> topK(int[] arr, boolean[] op, int k) {
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            res.add(whosYourDaddies.getDaddies());
        }
        return res;
    }
    ...
    public boolean sameAnswer(List<List<Integer>> res1, List<List<Integer>> res2) {
    ...
    public static void main(String[] args) {
        ...
        Code02_EveryStepShowBoss solution = new Code02_EveryStepShowBoss();
        System.out.println("测试开始");
        for (int i = 0; i < testTimes; i++) {
            Data testData = solution.randomData(maxValue, maxLen);
            int k = (int) (Math.random() * maxK) + 1;
            int[] arr = testData.arr;
            boolean[] op = testData.op;
            List<List<Integer>> res1 = solution.topK(arr, op, k);
            List<List<Integer>> res2 = solution.compare(arr, op, k);
            if (!solution.sameAnswer(res1, res2)) {
