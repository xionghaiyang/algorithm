...
public class Code02_SnacksWays {
    ...
    public int ways1(int[] arr, int w) {
        //arr[0...]
    ...
    public int ways2(int[] arr, int w) {
        int N = arr.length;
    ...
    public int ways3(int[] arr, int w) {
        int N = arr.length;
    ...
    public static void main(String[] args) {
        Code02_SnacksWays solution = new Code02_SnacksWays();
        int[] arr = {4, 3, 2, 9};
        int w = 8;
        System.out.println(solution.ways1(arr, w));
        System.out.println(solution.ways2(arr, w));
        System.out.println(solution.ways3(arr, w));
    }
