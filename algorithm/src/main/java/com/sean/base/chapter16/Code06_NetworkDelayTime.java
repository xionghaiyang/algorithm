...
/**
 * @Auther: xionghaiyang
 * @Date: 2022-11-01 22:23
 * @Description: leetcode 743题
 */
public class Code06_NetworkDelayTime {
    ...
    public class Heap {
        ...
        private void heapify(int i) {
            int left = i * 2 + 1;
            while (left < size) {
                int smallest = left + 1 < size && heap[left + 1][1] < heap[left][1] ? left + 1 : left;
        ...
        private void swap(int i, int j) {
            int[] o1 = heap[i];
            int[] o2 = heap[j];
            int o1hi = this.hIndex[o1[0]];
            int o2hi = this.hIndex[o2[0]];
            heap[i] = o2;
            heap[j] = o1;
            hIndex[o1[0]] = o2hi;
            hIndex[o2[0]] = o1hi;
