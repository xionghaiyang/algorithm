...
public class Code06_Dijkstra {
    ...
    private Node getMinDistanceAndUnselectedNode(HashMap<Node, Integer> distanceMap, HashSet<Node> touchedNodes) {
        Node minNode = null;
    ...
    public class NodeHeap {
        ...
        //key 某一个节点,value从源节点出发到该节点的目前最小距离
