...
public class Code01_MorrisTraversal {
    ...
    public static void main(String[] args) {
        Code01_MorrisTraversal solution = new Code01_MorrisTraversal();
        ...
        solution.morrisPre(head);
        solution.morrisIn(head);
        solution.morrisPos(head);
        System.out.println(solution.isBST(head));
    }
