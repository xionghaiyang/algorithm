...
public class Code03_SkipListMap {
    ...
    public class SkipListNode<K extends Comparable<K>, V> {
        ...
        //遍历的时候，如果是往右遍历到的null(next==null),比哪里结束
    ...
    public static void main(String[] args) {
        SkipListMap<String, String> test = new Code03_SkipListMap().new SkipListMap<>();
        printAll(test);
        System.out.println("=====================");
        test.put("A", "10");
        printAll(test);
